...
// compatibility with megaXX8 processors
	...
	#define UBRRL				UBRR0L
	#define UBRRH				UBRR0H
	#define USART_TXC_vect		SIG_USART_TRANS
	#define USART_RXC_vect		SIG_USART_RECV
	#define USART_UDRE_vect		SIG_USART_DATA
#endif
...
// (if you need to use both uarts, please use the uart2 library)
	...
	#define UCR					UCSR0B
	#define UBRRL				UBRR0
	#define USART_TXC_vect		SIG_UART0_TRANS
	#define USART_RXC_vect		SIG_UART0_RECV
	#define USART_UDRE_vect		SIG_UART0_DATA
#endif
	...
	#define UBRRL				UBRR1L
	#define UBRRH				UBRR1H
	#define USART_TXC_vect		SIG_UART1_TRANS
	#define USART_RXC_vect		SIG_UART1_RECV
	#define USART_UDRE_vect		SIG_UART1_DATA
#else
	#define UDR					UDR0
	#define UCR					UCSR0B
	#define UBRRL				UBRR0L
